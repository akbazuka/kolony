...
//        UINavigationBar.appearance().titleTextAttributes = attributes //Changes font of navigationbar title
//        
//        setupNavBar()
//    }
//    
...
//        
//        listener.remove()       //Removes listeners to save data in Firestore; stops real timeupdates
//        products.removeAll()    //Delete data from Firestore cache to avoind duplicating data everytime view appears
...
//    }
//    
//    //Fetch all documents of a certain collection Firestore Database and Listens for Real-TimeUpdates
//    func setOrdersListener() {
//        /* - Snapshot Listeners allows Real-Time Updates; assign listener variable and do somethingwith it when view appears and is destroyed
